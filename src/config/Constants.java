...
public class Constants {
    ...
    public static String DEFAULT_TEAMCONF_DIRECTORY
    ...
    public static class MapColor {
        ...
        public static final Color explored() {
            return Color.WHITE;
        }

        public static final Color explored_base() {
            return Color.YELLOW;
        }

        public static final Color safe() {
            return Color.GREEN;
        }

        public static final Color unexplored() {
            return Color.LIGHT_GRAY;
        }

        public static final Color relay() {
            return Color.RED;
        }
        ...
        public static final Color sensed() {
            return Color.CYAN;
        }

        public static final Color comm() {
            return Color.BLUE;
        }

        public static final Color obstacle() {
            return Color.RED;
        }
        ...
        public static final Color slope() {
            return Color.YELLOW;
        }

        public static final Color hill() {
            return new Color(255, 150, 0);
        }

        public static final Color wall() {
            return Color.BLACK;
        }
        ...
        public static final Color frontier() {
        ...
        public static final Color skeleton() {
            return Color.BLACK;
        }

        public static final Color keyPoints() {
            return Color.LIGHT_GRAY;
        }

        public static final Color rvPoints() {
            return Color.RED;
        }

        public static final Color childRV() {
            return Color.ORANGE;
        }

        public static final Color parentRV() {
            return Color.GREEN;
        }

        public static final Color hierarchy() {
            return Color.MAGENTA;
        }
    }
